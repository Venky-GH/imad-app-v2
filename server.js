...
app.get('/ui/batman-logo-wallpaper-for-desktop-1080p-123.jpg', function(req,res){
   res.sendFile(path.join(__dirname, 'ui', 'batman-logo-wallpaper-for-desktop-1080p-123.jpg')); 
});
